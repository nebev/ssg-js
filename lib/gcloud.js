...
var gcloudContainerClustersList = function(projectId, projectName) {
    let jsonString = '[]';
//    try {
//        jsonString = child_process.execSync('gcloud container clusters list --project=' + projectId + ' --format=json').toString();
//    } catch(error) {
//        jsonString = '[]';
//    }
